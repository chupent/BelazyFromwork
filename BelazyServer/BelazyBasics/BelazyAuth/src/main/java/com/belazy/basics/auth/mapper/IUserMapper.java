...
public interface IUserMapper {
    String SQL = "SELECT u.id  , u.account,u.phone_number,u.email , u.`password` , u.is_account_enabled , u.is_account_expired , u.is_account_locked , u.is_credentials_expired FROM sys_user u WHERE u.is_deleted = 0 AND \t";
