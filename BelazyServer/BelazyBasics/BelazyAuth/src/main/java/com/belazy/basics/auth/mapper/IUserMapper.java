...
public interface IUserMapper {
    String SQL = "SELECT u.id  , u.account , u.`password` , u.nickname , u.`name` , u.phone , u.is_account_enabled , u.is_account_expired , u.is_account_locked , u.is_credentials_expired FROM sys_belazy_user u WHERE u.is_deleted = 0";
