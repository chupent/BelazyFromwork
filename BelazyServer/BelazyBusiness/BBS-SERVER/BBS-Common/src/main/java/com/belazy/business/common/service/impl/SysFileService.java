...
import com.belazy.business.common.mapper.ISysFileMapper;
...
@Service
@Transactional
public class SysFileService  extends ServiceImpl<ISysFileMapper, SysFileEntity> implements ISysFileService {
